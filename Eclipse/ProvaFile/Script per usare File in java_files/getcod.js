...
us_="programmerai",n_=c_="";l_=""+screen.width;d_=document.referrer;var o_=new Date();vu_="&VUT=-1";
r_=""+escape(d_);
...
document.write("<a href=\"http://s6.shinystat.com/cgi-bin/shinystatv.cgi?USER="+us_+"&NH=1\" Target=\"_new\"><img src=\"http://s6.shinystat.com/cgi-bin/shinystat.cgi?USER="+us_+"&REFER="+r_+"&COLOR="+c_+"&SIZE="+l_+vu_+n_+"&VJS=4001\" border=\"0\"></a>");
// -->
